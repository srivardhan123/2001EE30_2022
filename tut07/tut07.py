...
try:
    ...
    def octant_analysis(mod):
        ...
        def octant_identification(val,val1,val2):
            ...
            if (val>=0 and val1>=0 and val2>=0):
                ...
                print('1')
        #here reading all the input files which is in the input folder.
        for f in csv_files:
            try:
                ...
                #now appling bordes,colors to cell using workbook/
                ...
                print("please make sure your input file is correct or wrong/any other compilation error takes place")
    ...
    print("Please install modules which are required (mentioned in top)")
